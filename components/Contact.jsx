...
const Contact = () => {
    return (
        <div className='w-full h-auto bg-neutral-80 '>
            <div className='w-full px-14 py-16 sm:px-20 sm:py-16 md:px-20 md:py-28 lg:px-40 lg:py-32 flex flex-col justify-evenly gap-4 text-primary '>
                <h1 className='sm:text-lg md:text-xl font-literata '>CONNECT</h1>
                <div className='flex lg:flex-row flex-col md:gap-12 gap-6 justify-between'>
                    <div className='flex flex-col md:flex-row md:gap-24 z-40'>
                        ...
                        <div className='flex justify-between md:gap-6 flex-col text-3xl md:text-5xl   font-oswald font-semibold'>
                            ...
                            <p><a href="https://www.behance.net/neelothpal" target="_blank" rel="noopener noreferrer">Behance</a></p>
